...
slider1 = st.slider("User", min_value=1, max_value=10, value=1)
print(slider1)
slider2 = st.slider("Courses", min_value=1, max_value=10, value=2)
print(slider2)
...
# Create a streamlit subheader widget
st.subheader("The sum of User course and Recommend is: ")
